  ...
  return (
    <section className="section-padding bg-background">
      <div ref={ref} className="section-container">
        ...
        <div className={`grid md:grid-cols-2 gap-10 md:gap-14 items-center reveal ${visible ? 'visible' : ''}`} style={{ transitionDelay: '0.1s' }}>
          {/* Image */}
          ...
          <div className="space-y-8 order-1 md:order-2">
            {t.adoption.steps.map((step, i) => (
              <div
                ...
                style={{ transitionDelay: visible ? `${0.15 + (i + 1) * 0.15}s` : '0s' }}
              >
